...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
  ...
  <xsl:template match="tei:note">
    ...
    <div id="catalogo-note-text-{./ancestor::tei:item/@n}" class="catalogo-note-search-results truncate-line-clamp">
      <xsl:apply-templates/>
    </div>
    <a id="catalogo-note-text-toggle-{./ancestor::tei:item/@n}" class="catalogo-note-search-results-toggle" href="#"><i class="bi bi-caret-down"></i><span>Show More</span></a>
  </xsl:template>
