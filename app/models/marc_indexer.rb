...
class MarcIndexer < Blacklight::Marc::Indexer
  ...
  def initialize
    ...
    to_field 'related_name_display', extract_marc('700aqbcdk:710abcdfgkln:711abcdfgklnpq', trim_punctuation: true) do |_record, accumulator|
...
class SolrWriterAccumulator < Traject::SolrJsonWriter
  ...
  def put(context)
    super
    @all_records[context.output_hash['id']] = context.output_hash
  end
end
