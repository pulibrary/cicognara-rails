...
RSpec.describe VersionsController, type: :controller do
  ...
  describe 'GET #show' do
    it 'assigns the requested version as @version' do
      version = Version.create! valid_attributes
      get :show, { book_id: book, id: version }, valid_session
  ...
  describe 'GET #edit' do
    it 'assigns the requested version as @version' do
      version = Version.create! valid_attributes
      get :edit, { book_id: book, id: version }, valid_session
      expect(assigns(:version)).to eq(version)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Version' do
        expect do
          post :create, { book_id: book, version: valid_attributes }, valid_session
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved version as @version' do
        post :create, { book_id: book, version: invalid_attributes }, valid_session
        expect(assigns(:version)).to be_a(Version)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested version' do
        version = Version.create! valid_attributes
        put :update, { book_id: book, id: version.to_param, version: new_attributes }, valid_session
        version.reload
      ...
      it 'assigns the requested version as @version' do
        version = Version.create! valid_attributes
        put :update, { book_id: book, id: version, version: valid_attributes }, valid_session
        expect(assigns(:version)).to eq(version)
      end
    ...
    context 'with invalid params' do
      it 'assigns the version as @version' do
        version = Version.create! valid_attributes
        put :update, { book_id: book, id: version.to_param, version: invalid_attributes }, valid_session
        expect(assigns(:version)).to eq(version)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested version' do
      version = Version.create! valid_attributes
      expect do
        delete :destroy, { book_id: book, id: version }, valid_session
      end.to change(Version, :count).by(-1)
    end
